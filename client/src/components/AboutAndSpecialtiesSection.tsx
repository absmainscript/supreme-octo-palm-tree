            ...
            >
              <div className="bg-white/70 backdrop-blur-sm rounded-3xl border border-white/20 shadow-sm hover:shadow-lg transition-all duration-500 p-8 lg:p-10 h-full flex flex-col">
                ...
                <div className="mb-8">
                  ...
                  >
                    <span className={`text-xs font-medium text-white px-5 py-2 rounded-full ${badgeGradient ? `bg-gradient-to-r ${BADGE_GRADIENTS[badgeGradient as keyof typeof BADGE_GRADIENTS]}` : 'bg-gradient-to-r from-pink-500 to-purple-500'} shadow-lg`}>
                      SOBRE MIM
                    </span>
                  </motion.div>
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-3xl border border-white/20 shadow-sm hover:shadow-lg transition-all duration-500 p-8 lg:p-10 h-full flex flex-col">
                ...
                <div className="text-center mb-6">
                  <motion.div
                    ...
                    transition={{ duration: 0.5, delay: 0.1 }}
                  >
                    <span className={`text-xs font-medium text-white px-5 py-2 rounded-full bg-gradient-to-r ${badgeGradientCSS} shadow-lg`}>
                      ESPECIALIDADES
                    </span>
                  </motion.div>
